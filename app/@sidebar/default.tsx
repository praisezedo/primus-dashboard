    ...
    return <>
       <aside className="pt-7 fixed border-r border-gray-200 shadow-md top-17 bg-white bottom-0 left-0  w-50 text-black ">
        <nav className="justify-center flex flex-col gap-10 px-7">
           <Link className={`flex gap-3 p-2 rounded-lg hover:cursor-pointer group relative font-bold ${isActive('/') ? 'bg-gray-400' : 'bg-white'}`} href="/">
           ...
           <Link className={`flex gap-3 p-2 rounded-lg hover:cursor-pointer group relative font-bold ${isActive('/students') ? 'bg-gray-400' : 'bg-white'}`} href="/students">
           ...
           <Link className={`flex gap-2 p-2 rounded-lg hover:cursor-pointer group relative font-bold ${isActive('/students/add') ? 'bg-gray-400' : 'bg-white'}`} href="/students/add">
           ...
           <Link className={`flex gap-3 p-2 rounded-lg hover:cursor-pointer group relative font-bold ${isActive('/students/upload') ? 'bg-gray-400' : 'bg-white'}`} href="/students/upload">
